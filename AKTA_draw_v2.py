...
if __name__ == '__main__':
    filename = '20251029_m3C-a-synuclein(1-140)-30aa_IEX_run+equi 001 001.csv'
    UV=(-20, 10) # if surpass this figure, programme will automatically chose the upper bound
    Cond = (0, 50)
    save_figure = True
